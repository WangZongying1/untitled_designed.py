...
def build_rects_and_color_alphas_for_grid(grid_size_0_level, level_size_0, slice_func=slice_rect2):
...
def build_grid_level_from_rects(level, rects_0_level, intensities, slide_helper: SlideHelper):
    level_size = slide_helper.get_level_size(level)
    level_downsample = slide_helper.get_downsample_for_level(level)
    rects = [(
